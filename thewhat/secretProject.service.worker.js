...
/** @type {string} */
const CACHE_VERSION = '1735969396|126629540826';
/** @type {string} */
const CACHE_PREFIX = 'Secret BB Projec-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'secretProject.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["secretProject.html","secretProject.js","secretProject.offline.html","secretProject.icon.png","secretProject.apple-touch-icon.png","secretProject.worker.js","secretProject.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["secretProject.wasm","secretProject.pck"];
